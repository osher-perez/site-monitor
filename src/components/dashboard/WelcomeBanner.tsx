...
export const WelcomeBanner = ({ name = "משתמש", plan = "בסיסי (חינם)", sitesCount, maxLimit }: WelcomeBannerProps) => {
  ...
  const firstLetter = decodedName && decodedName.trim() ? decodedName.trim()[0].toUpperCase() : "M";
  ...
  return (
    <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-right" dir="rtl">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-black text-gray-950">שלום, {decodedName}</h1>
