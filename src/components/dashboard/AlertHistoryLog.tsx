              ...
              >
                ...
                <td className="py-3.5">
                  <div className="flex items-center gap-3 text-gray-500 font-medium">
                    {event.channels.email !== "none" && (
                      <span
                        className={
                          event.channels.email === "sent"
                            ? "text-gray-700"
                            : "text-rose-500"
                        }
                      >
                        מייל {event.channels.email === "sent" ? "✓" : "✗"}
                      </span>
                    )}
                    {event.channels.telegram !== "none" && (
                      <span
                        className={
                          event.channels.telegram === "sent"
                            ? "text-gray-700"
                            : "text-rose-500"
                        }
                      >
                        טלגרם {event.channels.telegram === "sent" ? "✓" : "✗"}
                      </span>
                    )}
                  </div>
                </td>
